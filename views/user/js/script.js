		...
		fields: {
			name: {
                validators: {
                    ...
                    stringLength: {
                        min: 4,
                        message: 'El nombre debe tener un minimo de 4 caracteres'
                    },
                    regexp: {
            ...
            lname: {
                validators: {
                    ...
                    stringLength: {
                        min: 4,
                        message: 'El apellido debe tener un minimo de 4 caracteres'
                    },
                    regexp: {
                        regexp: /^[a-zA-ZñÑáéíóúÁÉÍÓÚ_\. ]+$/,
                        message: 'Introduzca caracteres validos'
            ...
            user: {
                validators: {
                    ...
                    stringLength: {
                        min: 3,
                        max: 15,
                        message: 'El usuario debe tener un minimo de 3 caracteres'
                    },
                    regexp: {
                        regexp: /^[a-zA-Z0-9_.]+$/,
            ...
            emailU: {
                validators: {
                    ...
                    regexp: {
                        regexp: /^[a-zA-Z0-9_\.-]+@dominio.com.gt+$/,
                        message: 'introduzca un correo valido. Con el dominio @dominio.com.gt'
                    }
                }
            },
            pass: {
