<?php
    include_once dirname(__file__,3).'/models/users.php';
    include_once dirname(__file__,3).'/models/position.php';
    include_once dirname(__file__,3).'/models/permission.php';
    ...
    $data = $users->getEmployeeById($id);
    if ($data) {
        $options = $positions->getPositions();
        $listPer = $permissions->getPermissions($data->Id_Usuario);
            $data->Id_Empleado = $users->encrypt($data->Id_Empleado);
            $data->Id_Usuario = $users->encrypt($data->Id_Usuario);
?>
            ...
            <div class="modal-body"><!-- body modal -->
                <div class="wizard"><!-- wizard -->
                    ...
                    <form role="form" class="form-horizontal" id="userForm" autocomplete="off"><!-- form -->
                        <input type="hidden" id="id0" name="id0" value="<?php echo $data->Id_Empleado ?>">
                        <input type="hidden" id="id1" name="id1" value="<?php echo $data->Id_Usuario ?>">
                        <div class="tab-content"><!-- tab-content wizard -->
                            <div class="tab-pane active" role="tabpanel" id="step1">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Nombre del trabajador" value="<?php echo $data->Nombre ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="lname" class="col-sm-2 control-label">Apellido</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="lname" name="lname" placeholder="Apellido del trabajador" value="<?php echo $data->Apellido ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" id="position" name="position">
                                            <option value="" disabled="true">Cargo en de la empresa</option>
                                            <?php
                                                foreach ($options as $value) {
                                                    $SL = '';
                                                    if ($data->Id_Cargo == $value->Id_Cargo) {
                                                        $SL = 'selected="true"';
                                                    }
                                                    echo '<option value="'.$value->Id_Cargo.'" '.$SL.'>'.$value->Descripcion.'</option>';
                                                }
                                            ?>
                                        </select>
                                    </div>
                            ...
                            <div class="tab-pane" role="tabpanel" id="step2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="tel" class="form-control" id="phone" name="phone" placeholder="Telefono personal con Formato (502) 1234-56789" value="<?php echo $data->Telefono ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="emailP" class="col-sm-2 control-label">Correo</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="emailP" name="emailP" placeholder="Correo personal" value="<?php echo $data->CorreoP ?>">
                                    </div>
                                </div>
                                <ul class="list-inline pull-right">
                                    <li><button type="button" class="btn btn-default" data-dismiss="modal" aria-label="Close">Cancelar</button></li>
                            ...
                            <div class="tab-pane" role="tabpanel" id="step3">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="user" name="user" placeholder="Usuario de acceso alternativo" value="<?php echo $data->Usuario ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="emailU" class="col-sm-2 control-label">Correo</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="emailU" name="emailU" placeholder="Correo de acceso" value="<?php echo $data->CorreoU ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <label>
                                            <input type="checkbox" id="rememberPass" name="rememberPass" checked="true"> Usar contraseña almacenada
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="password" class="form-control" id="pass" name="pass" autocomplete="false" placeholder="********">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="confirPass" class="col-sm-2 control-label">Confirmar</label>
                                    <div class="col-sm-10">
                                        <input type="password" class="form-control" id="confirPass" name="confirPass" autocomplete="false" placeholder="********">
                                    </div>
                                </div>
                                <ul class="list-inline pull-right">
                                    <li><button type="button" class="btn btn-default" data-dismiss="modal" aria-label="Close">Cancelar</button></li>
                            ...
                            <div class="tab-pane" role="tabpanel" id="complete">
                                    ...
                                    <?php
                                        ...
                                        foreach ($menu as $key => $value) {
                                            ...
                                            foreach ($value as $subKey => $subVal) {
                                                $checked = '';
                                                foreach ($listPer as $page) {
                                                    if ($subKey == $page->Id_Pagina) {
                                                        $checked = "checked";
                                                    }
                                                }
                                                $j++;
                                                echo '<label class="permission">
                                                    <input type="checkbox" id="input_'.$idCheckParent."_".$j.'" value="'.$subKey.'" name="permission[]" '.$checked.'>'.$SubMenu[$subKey]["Descripcion"].'
                                                </label><br>';
                                            }
                                            echo '</div></td>';
                                            $i++;
                                ...
                                <ul class="list-inline pull-right">
                                    <li><button type="button" class="btn btn-default" data-dismiss="modal" aria-label="Close">Cancelar</button></li>
                                    <li><button type="button" class="btn btn-default prev-step">Regresar</button></li>
                                    <li><input type="submit" class="btn btn-success" name="edit" value="Finalizar"></li>
                                </ul>
                            </div>
...
<script>
    $.getScript("./views/user/js/script.js");
</script>
